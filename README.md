...
[![My Skills](https://skillicons.dev/icons?i=py,docker,supabase,sklearn,selenium,tensoflow,firebase,AWS,c,eclipse,fastapi,gcp,git,heroku,java,latex,netlify,npm,yarn,postgres,postman,regex,react,js,html,ubuntu,vscode,css,wasm)](https://skillicons.dev)
